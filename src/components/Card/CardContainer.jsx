...
const CardContainer = () => {
  return (
    <main className="bg-[#3973D4] p-[20px] h-[232px]">
      <div className="bg-neutral rounded-[24px] mx-auto flex flex-col justify-center text-center gap-[20px] p-[20px] min-w-[271px] drop-shadow-lg mb-[20px]">
        <div className=" flex flex-col">
          ...
          <div className="flex flex-row justify-center p-[12px] align-middle">
            <div >
              <AccessTimeOutlinedIcon style={{ fontSize: '12px', height:'12px' }} className="text-[#3973D4]" />
            </div>
            <h1 className="pl-[12px] text-[12px] text-[#3973D4] h-[12px] mb-[10px] font-[400]">6d to expiry</h1>
          </div>
        </div>
