...
const CardSwipe = ({ apiData, handleSwipe }) => {
  ...
  // Define remaining and formatDate functions here
  ...
  return (
    <div className="bg-primary w-full overflow-hidden">
      ...
      <div className="custom-swipe-buttons">
        <button onClick={() => handleSwipeChange("left")}>Swipe Left</button>
        <button onClick={() => handleSwipeChange("right")}>Swipe Right</button>
      </div>
    </div>
  );
};
