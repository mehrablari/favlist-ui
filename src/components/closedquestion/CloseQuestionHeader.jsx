...
const CloseQuestionHeader = () => {
  return (
    <div className="flex flex-col pt-[120px] px-[20px] pb-[30px] shadow-lg  h-[116px] bg-neutral w-full justify-center ">
        ...
        <div className="flex justify-between flex-row py-[10px]">
          <p className="font-[700] text-[18px] leading-5">Closed questions</p>
          <div className="flex flex-row items-center rounded-sm bg-primary-border p-[6px]">
            <img src={filterIcon} alt="" className="h-[22px] pr-[5px]" />
            <Link to="/" className="text-[16px] font-semibold text-primary">
              Filter
            </Link>
          </div>
        </div>
